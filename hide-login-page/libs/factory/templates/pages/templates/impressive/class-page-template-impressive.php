...
if ( ! class_exists( 'WBCR\Factory_Templates_103\Impressive' ) ) {
	/**
	 * Class Wbcr_FactoryPages445_ImpressiveThemplate
	 */
	abstract class Impressive extends \Wbcr_FactoryPages445_AdminPage {
		...
		public function __construct( \Wbcr_Factory446_Plugin $plugin ) {
			$this->menuIcon = FACTORY_TEMPLATES_103_URL . '/pages/templates/impressive/assets/img/webcraftic-plugin-icon.png';
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_103_URL . '/pages/templates/impressive/assets/css/impressive.page.template.css' );
		}
		...
		public function flushCacheAndRulesAction() {
			...
			if ( class_exists( 'WBCR\Factory_Templates_103\Helpers' ) ) {
				\WBCR\Factory_Templates_103\Helpers::flushPageCache();
			}
		...
		protected function showOptions() {
            ...
            <div id="WBCR" class="wrap">
                <div class="wbcr-factory-templates-103-impressive-page-template factory-bootstrap-446 factory-fontawesome-000">
