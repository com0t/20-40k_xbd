...
class WHLP_HideLoginPage extends WBCR\Factory_Templates_103\Pages\PageBase {
	...
	protected function getNewLoginUrl() {
		...
		if ( \WBCR\Factory_Templates_103\Helpers::isPermalink() ) {
			return \WBCR\Factory_Templates_103\Helpers::userTrailingslashit( home_url( '/' ) . $login_path );
		} else {
