...
if( !class_exists('Wbcr_FactoryPages445_ImpressiveThemplate') ) {
	...
	abstract class Wbcr_FactoryPages445_ImpressiveThemplate extends Wbcr_FactoryPages445_AdminPage {
		...
		{
			$this->menuIcon = FACTORY_PAGES_445_URL . '/templates/assets/img/webcraftic-plugin-icon.png';
		...
		public function assets($scripts, $styles)
		{
			...
			$this->styles->add(FACTORY_PAGES_445_URL . '/templates/assets/css/impressive.page.template.css');
		}
